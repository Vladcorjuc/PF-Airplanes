...
/* package cabal-airplane-0.1.0.0 */
#define VERSION_cabal_airplane "0.1.0.0"
#define MIN_VERSION_cabal_airplane(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "cabal-airplane-0.1.0.0"

#define CURRENT_PACKAGE_KEY "cabal-airplane-0.1.0.0"
